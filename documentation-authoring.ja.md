...
- `dictation.md`: language-specific dictation files から導いた agent-facing summary と cross-language guidance
...
`dictation.md` は AI agent が理解できる内容にし、language-specific record を置き換えず、実務上の guidance を要約します。
